...
BLOCK* read_BLOCK (JPEG_INFO* info, u8 chan_id) {
    ...
    while (1){
        ...
        // RRRRSSSS
            ...
            u8 upper = (symbol_len & 0xF0) >> 4;
            u8 lower = (symbol_len & 0x0F);
            ...
            (*obj)[i] = get_symbol(lower, info->fp);
            i++;
        }
    }
